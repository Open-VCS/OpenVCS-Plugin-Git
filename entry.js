...
try {
  ...
  const ensureLockStyle = () => {
    ...
    style.textContent = `
      ...
      .lfs-locks-modal .dialog.sheet{ width:min(1200px, 98vw); max-height:90vh; }
      .lfs-locks-modal .sheet-body{ max-height:78vh; overflow:auto; }
      ...
      .submodules-modal .dialog.sheet{ width:min(1320px, 98vw); max-height:90vh; }
      .submodules-modal .sheet-body{ max-height:78vh; overflow:auto; }
